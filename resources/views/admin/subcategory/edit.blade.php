  ...
  <div class="row">
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
             <div class="row">
               <div class="col-md-6"> <h3 class="card-title"> Update subcategory</h3></div>
               <div class="col-md-6 text-right"> <a class="btn btn-info py-2" href="{{ route('subcategories.index') }}">All subcategory</a></div>
           </div>
            <form method="POST" class="forms-sample" action="{{ route('subcategories.update',$subcategory->id) }}">
              @method('PUT')
              @csrf
              <div class="form-group">
                <label>Subcategory English</label>
                <input type="text" class="form-control" name="subcategory_en" value="{{ $subcategory->subcategory_en }}"  placeholder="Subcategory English">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_hindi" value="{{ $subcategory->subcategory_hindi }}"  placeholder="Subcategory Hindi">
