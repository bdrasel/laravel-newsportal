  ...
  <div class="row">
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
             <div class="row">
               <div class="col-md-6"> <h3 class="card-title"> Update Prayer Setting</h3></div>
           </div>
            <form method="POST" class="forms-sample" action="{{ route('update.prayer',$prayer->id) }}">
              @csrf
              <div class="form-group">
                <label>Fajar</label>
                <input type="text" class="form-control" name="fajar" value="{{ $prayer->fajar }}">
                @error('fajar')
              ...
              <div class="form-group">
                <label>Zummah</label>
                <input type="text" class="form-control" name="zummah" value="{{ $prayer->zummah }}">
                @error('zummah')
                  <div class="invalid-feedback"> 
                    <strong><span>{{ $message }}</span></strong>
                  </div>
