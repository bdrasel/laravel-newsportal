    ...
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" class="forms-sample" action="{{ route('update.photo',$photo->id) }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
               <div class="row">
                ...
                <div class="form-group col-md-6">
                  <img src="{{ URL::to($photo->photo) }}" style="width: 80px; height: 60px; margin-top: 10px" alt="photo">
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" name="type">
                    <option value="1" {{ $photo->type == 1 ? 'selected':'' }} >Big Image</option>
                    <option value="0" {{ $photo->type == 0 ? 'selected':'' }}>Small Image</option>
                  </select>
              </div>
