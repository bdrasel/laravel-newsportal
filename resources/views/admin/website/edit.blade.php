...
@section('title','update Website Link')
@section('content')        
  ...
  <div class="row">
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
             <div class="row">
               <div class="col-md-6"> <h3 class="card-title"> Add website</h3></div>
               <div class="col-md-6 text-right"> <a class="btn btn-info py-2" href="{{ route('all.website') }}">All Website Link</a></div>
           </div>
            <form method="POST" class="forms-sample" action="{{ route('update.website',$website->id) }}">
              @csrf
