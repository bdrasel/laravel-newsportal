    ...
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" class="forms-sample" action="{{ route('store.ads') }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                  <input type="file" name="ads" class="form-control file-upload-info" placeholder="Upload Photo">
