  ...
  <div class="row">
    <div class="col-md-1"></div>
        ...
        <div class="card">
          <div class="card-body">
             <div class="row">
               <div class="col-md-6"> <h3 class="card-title"> Update District Information</h3></div>
               <div class="col-md-6 text-right"> <a class="btn btn-info py-2" href="{{ route('distracts.index') }}">All District</a></div>
           </div>
            <form method="POST" class="forms-sample" action="{{ route('distracts.update',$district->id) }}">
              @method('PUT')
              @csrf
              <div class="form-group">
                <label>District English</label>
                <input type="text" class="form-control" name="district_en" value="{{ $district->district_en }}" placeholder="District English">
                @error('district_en')
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="district_hindi" value="{{ $district->district_hindi }}" placeholder="District Hindi">
